...
public class Teacher_content extends TabActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        intent=new Intent().setClass(this, Teacher_index.class);
        spec=tabHost.newTabSpec("首页").setIndicator("首页").setContent(intent);
        tabHost.addTab(spec);
        
        intent=new Intent().setClass(this,Teacher_word.class);
        spec=tabHost.newTabSpec("单词").setIndicator("单词").setContent(intent);
        tabHost.addTab(spec);
        
        intent=new Intent().setClass(this, Teacher_my.class);
        spec=tabHost.newTabSpec("我的").setIndicator("我的").setContent(intent);
        tabHost.addTab(spec);
        
     
        intent=new Intent().setClass(this, Teacher_setting.class);
