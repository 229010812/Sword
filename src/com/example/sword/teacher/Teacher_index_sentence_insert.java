...
public class Teacher_index_sentence_insert extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.teacher_index_sentence_insert);
		insertsentence = (EditText) findViewById(R.id.seninsertsentence);
		fanyi = (EditText) findViewById(R.id.senfanyi);
		...
		inputword.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (j != 0)
					Toast.makeText(Teacher_index_sentence_insert.this, "成功", 8000).show();
				else
					Toast.makeText(Teacher_index_sentence_insert.this, "失败 ", 8000)
							.show();
			}
		});
		Scancle.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(Teacher_index_sentence_insert.this,Teacher_content.class);
